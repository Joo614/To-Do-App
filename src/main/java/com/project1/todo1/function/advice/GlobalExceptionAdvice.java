package com.project1.todo1.function.advice;

import com.project1.todo1.function.exception.BusinessLogicException;
import com.project1.todo1.function.response.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST) // --> HTTP Status 를 HTTP Response 에 포함
